...
export function WizardStepJD({ jobTitle, jobCompany, initialJD, onNext, onBack, onJDChange, navDir }: Props) {
  const editorRef = useRef<HTMLDivElement>(null);
  const [empty, setEmpty] = useState(!initialJD.replace(/<[^>]*>/g, '').trim());
      ...
      <div className="wz-header">
        <div className="wz-header-title-row">
          ...
          <div className="wz-header-text">
            <div className="wz-title">Add the job description</div>
            <div className="wz-subtitle">Paste a job posting, so we can tailor your resume accurately.</div>
          </div>
        </div>
      </div>
